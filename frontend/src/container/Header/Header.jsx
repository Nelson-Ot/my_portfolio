    ...
    return (
        <div className="app__header app__flex">
            ...
            transition={{duration: 0.5, delayChildren: 0.5 }} className="app__header-img">
                <img src={images.nelson} alt="header" /> 
                <motion.img whileInView={{scale: [0, 1] }}transition= {{duration: 1, ease: 'easeInOut'}} src={images.circle} alt="profile picture" className="overlay_circle">
